...
TRAIN_DATA_PATH=../data/0921_train_2.json  # path to the training data json file
EVAL_DATA_PATH=../data/0921_internalvalidate_2.json   # path to the evaluation data json file (optional)
IMAGE_FOLDER=../data/image_jpg                     # path to the image root folder; if provided, the image paths in the json should be relative
...
RUN_ID=${MODEL_ID}_0928final_lora-${USE_LORA}_qlora-${Q_LORA}   # a custom run id that determines the checkpoint folder and wandb run name
